...
// 云平台上线时使用
//var WxApiRoot = 'https://www.luoqiangkun.top/wx/';
...
module.exports = {
  ...
  StoreGoods: WxApiRoot + 'store/goods', //店铺商品
  ...
  OrderExpress: WxApiRoot + 'order/express', // 物流
  ...
  UserInfo: WxApiRoot + "user",
  MallDetail: WxApiRoot + 'mall', //商场详情
  MallPickupTime: WxApiRoot + 'mall/pickupTime', //自提时间
};